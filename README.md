...
| [notification-basic-win](./plugins/notification/basic-win) | 基本款聲音通知插件 (Windows) | 當 Claude Code 執行結束或停止時，自動播放提示音通知用戶<br />**Hook:** `Notification` - 發送通知時播放音效<br />**Hook:** `Stop` - 停止執行時播放音效 |
